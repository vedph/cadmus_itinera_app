...
Quick Docker image build (after `ng build --prod`): `docker build . -t vedph2020/cadmus-itinera-app:1.0.3 -t vedph2020/cadmus-itinera-app:latest` (replace with the current version).
